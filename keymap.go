...
func NewDefaultKeyMap() *KeyMap {
	return &KeyMap{
		...
		FilePicker: FilePickerKeyMap{
			...
			Back:       key.NewBinding(key.WithKeys("h", "backspace", "left", "esc"), key.WithHelp("←", "previous folder"), key.WithDisabled()),
			Select:     key.NewBinding(key.WithKeys("l", "right", "enter"), key.WithHelp("enter", "select"), key.WithDisabled()),
